...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* Base
    ...
    * |------+------+------+------+------+------+------+------+------+------+------+------|
    * |      |  GUI | Ctrl |  Alt |Up-L  |Space |Space |Low-b | RALT | RCTL |   \  |      |
    * `-----------------------------------------------------------------------------------'
    */
  [0] = LAYOUT_ortho_4x12(
    ...
    KC_LCTL,          KC_LGUI, KC_LCTL, OSM(MOD_LALT), MO(2), KC_SPC, KC_SPC, LT(3, KC_BSPACE), KC_RALT, KC_RCTL,  KC_BSLS, KC_RCTL
  ),
  ...
  */
  [1] = LAYOUT_ortho_4x12(
    ...
    KC_LCTL,          KC_LGUI,            KC_LCTL, OSM(MOD_LALT),     _______,    _______, ALT(KC_PGUP),  LCTL(KC_BSPACE),    _______,    _______,    _______,   _______
  ),
  ...
  */
  [2] = LAYOUT_ortho_4x12(
    ...
    KC_LCTL, KC_LGUI, KC_LCTL, OSM(MOD_LALT), _______, _______, LALT(KC_PGUP),   LCTL(KC_F7), KC_0, KC_DOT, KC_SLSH, _______
  ),
