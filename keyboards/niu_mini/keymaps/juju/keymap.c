...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */ 
    [_MAIN_WIN] = LAYOUT_planck_mit(
      ...
      KC_LCTL,                 KC_LEAD, KC_LGUI, OSM(MOD_LALT), OSL(_SYM),       KC_SPC,     OSL(_FN),  _______, _______, TD(TD_SLASH_PIPE),   KC_RCTL
    ), 
    ...
    */  
    [_MAIN_MAC] = LAYOUT_planck_mit(
      ...
      KC_LCTL,                KC_LEAD, OSM(MOD_LALT), KC_LGUI,  OSL(_SYM),     KC_SPC,     OSL(_FN), _______, _______, TD(TD_SLASH_PIPE),   KC_LCTL
    ), 
    ...
    */
    [_NAV_WIN] = LAYOUT_planck_mit(
      ...
      _______, LCTL(LSFT(KC_Z)),            _______,      _______,    _______,                 LCTL(KC_P),       _______,      _______,    _______,     _______,        _______ 
    ),
    ...
    */
    [_SYM] = LAYOUT_planck_mit(
      ...
      LCTL(LSFT(KC_F3)), KC_PIPE,  KC_LBRC, KC_LCBR, KC_LPRN, KC_AMPR,   KC_AT, KC_1,   KC_2,    KC_3, KC_PAST, KC_EQL, 
      LCTL(LSFT(KC_F4)),  KC_F12,   KC_F11,   KC_F5, _______,     KC_BSPACE,    KC_0, KC_DOT, _______, KC_PSLS, KC_TILD
    ),
    ...
    */
    [_FN] = LAYOUT_planck_mit(
      ...
      _______, KC_F4,   KC_F5,  KC_F6, _______, _______, _______, KC_RPRN,  KC_RCBR, KC_RBRC, _______, _______, 
