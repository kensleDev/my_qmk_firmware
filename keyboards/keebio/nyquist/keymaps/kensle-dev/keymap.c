...
#define CTL_ETR MT(MOD_LCTL, KC_ENTER)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_ortho_4x12(
        ...
        _______, _______, _______, ST_ALT, LOW_BCK, ADJ_ESC, /**/ CTL_ETR,  RSE_SPE, ALT_BSLA, _______, _______,  _______
    ),

    [_LOWER] = LAYOUT_ortho_4x12(
        _______, KC_EXLM, KC_AT,   KC_HASH, KC_UNDS, KC_PERC,  /**/ KC_TAB,  KC_7,   KC_8, KC_9,    KC_PLUS, _______,
        ...
        _______, _______, _______, ST_ALT,  LOW_BCK, MOD_LCTL, /**/ CTL_ETR, LAUNCH, KC_0, _______, _______, _______
    ),
    ...
    [_RAISE] = LAYOUT_ortho_4x12(
        ...
        _______, _______, _______,  KC_F1,  KC_F2,  KC_F3,  /**/ CTL_ETR, RSE_SPE,  _______, _______,  _______,  _______
    ),
    ...
    [_ADJUST] = LAYOUT_ortho_4x12(
        ...
        _______, _______,    _______,    OSM(MOD_LALT), KC_SPC,       ADJ_ESC,     /**/  KC_BTN4, KC_BTN5,    CTL_ETR,    _______,    _______,    _______
    ), 
...
/* } */
    ...
    * |      |   Z  |   X  |   C  |   V  |   B  |  |  N   |   M  |   ,  |   .  |   /  |      |
    * |------+------+------+------+------+------|  |------+------+------+------+------+------|
    * |      |      |      | Alt  |BckLow|NavEsc|  |Enter |SpeRai| TAb  |      |      |      |
    * `-----------------------------------------.  .-----------------------------------------'
    */    
