...
#define C_ENTER MT(MOD_LCTL, KC_ENT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_ortho_4x12(
        ...
        _______, _______, _______, ST_ALT, LOW_BCK, ADJ_ESC, /**/ C_ENTER, RSE_SPE, KC_TAB,  _______, _______, _______
    ),
    ...
    [_LOWER] = LAYOUT_ortho_4x12(
        ...
        _______, _______, _______, ST_ALT,  LOW_BCK, MOD_LCTL, /**/ C_ENTER, LAUNCH, KC_0, _______, _______, _______
    ),

    [_RAISE] = LAYOUT_ortho_4x12(
        _______, _______, _______,  KC_F10, KC_F11, KC_F12, /**/ _______, KC_BTN1,  KC_BTN2, _______,  RESET,    _______,
        _______, _______, C_ENTER,  KC_F7,  KC_F8,  KC_F9,  /**/ _______, KC_MS_L,  KC_MS_D, KC_MS_U,  KC_MS_R,  _______,
        _______, _______, ST_ALT,   KC_F4,  KC_F5,  KC_F6,  /**/ _______, KC_RPRN,  KC_RCBR, KC_RBRC,  KC_TILD,  _______,
        _______, _______, _______,  KC_F1,  KC_F2,  KC_F3,  /**/ C_ENTER, RSE_SPE,  _______, _______,  _______,  _______
    ),
    ...
    [_ADJUST] = LAYOUT_ortho_4x12(
        ...
        _______, _______,    _______,    OSM(MOD_LALT), KC_SPC,       ADJ_ESC,     /**/  KC_BTN4, KC_BTN5,    C_ENTER,    _______,    _______,    _______
    ), 
